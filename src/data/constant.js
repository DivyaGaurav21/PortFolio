...
export const experiences = [
  ...
  },
  {
    ...
    desc: "I worked extensively on the IRCTC e-catering project, handling both the customer-facing and admin sides. On the customer side, I was responsible for integrating the home API, ensuring that the home content dynamically updated based on API data. I also developed various specialized pages, such as a train-friendly page, festive page, and Jain food page. To achieve this, I built a reusable component that could take data from APIs or configuration files to generate different pages with minimal changes, enhancing the flexibility and scalability of the system. On the admin side, I created mappings to facilitate the sale of water on trains, which involved managing configurations and ensuring the seamless functioning of this feature across the platform. Additionally, I played a key role in migrating the project from page-based routing to app-based routing, which improved the overall structure and maintainability of the codebase. Alongside this, I independently developed the official website for Ipsator using the Astro framework, handling both the front-end and back-end components. I primarily utilized HTML, CSS, JavaScript, Tailwind CSS, React, and Next.js, with TanStack Query for efficient data fetching and posting operations across the projects.",
    skills: [
      "ReactJS",
      "Next Js",
      "React-Query",

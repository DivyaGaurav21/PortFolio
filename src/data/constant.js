...
export const experiences = [
  {
    ...
    desc: "Worked on the IRCTC e-Catering platform across customer and admin modules, building scalable and reusable UI components for dynamic pages like train-specific, festive, and category-based experiences. Migrated the application from Pages Router to App Router, improving page load performance by ~30% using Server Components, optimized data fetching, and efficient code splitting. Enhanced state and data handling with Zustand and TanStack Query, reducing redundant API calls through caching. Delivered key features including Home API integration, theming, and a recommendation-based floating action button, while collaborating with cross-functional teams to ensure pixel-perfect and consistent UI.",
    skills: [
      "ReactJS",
      "Next Js",
      "React-Query",
  ...
  },
  {
    ...
    desc: "Contributed to EchoMind, a platform for discovering executive programs and managing class schedules with faculty availability. Developed the Karnataka Tourism multi-page platform using GraphQL with responsive UI and optimized performance. Built Ipsator’s official website with a focus on speed, responsiveness, and SEO. Gained hands-on experience with SSR and CSR while performing code reviews and fixing bugs across projects. Also built a blog platform using Next.js and Sanity CMS with Google Analytics (GA4) integration to track user engagement.",
    skills: [
      "Next JS",
      "ReactJS",
      "Tailwind Css",
...

  {
    ...
    desc: "After completing the MERN Stack course at Coding Ninjas, worked as a intern on a marketplace, building UI components like shopping carts, payment modules, and modals, along with feature-rich pages including media, reviews, and pagination. Integrated MongoDB for backend data handling and improved responsiveness for a seamless user experience. Gained practical experience in frontend development, collaborating with cross-functional teams to deliver a polished product.",
    skills: [
      "HTML",
      "CSS",
      "JAVASCRIPT",
